...
public class DataInitializer {
    ...
    public void init() {
        ...
        Country c2= countryRepository.save(new Country("China","Asia"));

        Author a1= authorRepository.save(new Author("Emilia","Kostofski",c1));
        Author a2=authorRepository.save(new Author("Ace","Kostofski",c2));

        bookRepository.save(new Book("1984", Category.CLASSICS,a1));
        bookRepository.save(new Book("Steve Jobs", Category.BIOGRAPHY,a2));
